...
#ifdef __llvm__
#include <stdint.h>
typedef int16_t got_level_i16;
#else
/* 16-bit DOS builds use 2-byte `int`. */
typedef int got_level_i16;
#endif
...
typedef struct {                           //size=512
  ...
  got_level_i16 static_x[LEVEL_MAX_STATIC_OBJ]; //332 X coor of static objects
  got_level_i16 static_y[LEVEL_MAX_STATIC_OBJ]; //392 Y coor of static objects
