...
//           }
      ...
      case 216:
           ...
           /* ep3: fall through to teleport code at case 217 */
      case 217:
           if(g_episode==1){
             return 0;
           }
           /* ep2 and ep3: teleport within the level */
           cx=(thor_x1+7)/16;
...
switch(icon){
      ...
      case 203:
           break;
      case 204:
           if(g_episode==1 || g_episode==3){
             break;
           }
           /* ep2: teflor is solid for actors */
           return 1;
      case 205:
...
//           break;
      ...
      case 216:
           ...
           /* ep1 and ep3: fall through to default */
           break;
      case 224:
      case 225:
      case 226:
