...
static char expf[4][8];
char exprow;
char expcnt;
//===========================================================================
void set_boss_ep3(ACTOR *actr){
...
//===========================================================================
#define LFC 10
int boss_movement_one_ep3(ACTOR *actr){    //boss - loki-2
...
//===========================================================================
int boss_movement_ep3(ACTOR *actr){    //boss - loki-1
int d,x1,y1,f,ox,oy;

if(actr->temp2) actr->temp2--;
if(boss_dead) return boss_die_ep3();
check_boss_hit_ep3();

if(!boss_mode) return boss_movement_one_ep3(actr);
num_pods1=10;
switch(setup.skill){
   case 0:
      actr->num_moves=3;
...
//===========================================================================
int endgame_one_ep3(void){    //explode
int x,y,r;
...
//===========================================================================
int endgame_movement_ep3(void){    //explode
int x,y,r;
