/* game_proto.h - Unified function prototypes for God of Thunder
 *
 * Union of 1_proto.h / 2_proto.h / 3_proto.h.
 * Boss functions use episode-specific names (dispatched via ep-> table).
 */
#ifndef GOT_GAME_PROTO_H
#define GOT_GAME_PROTO_H

#ifndef GOT_GFXCALL
#define GOT_GFXCALL
#endif

/* G_LIB - graphics primitives */
...
/* ep2/3: d_restore in grp.c; ep1: in back.c. Both are identical. */
void d_restore(void);
...
/* Boss functions - Episode 1 (defined in boss_ep1.c) */
...
/* Boss functions - Episode 2 (defined in boss_ep2.c) */
int  boss_movement_ep2(ACTOR *actr);
void check_boss_hit_ep2(ACTOR *actr,int x1,int y1,int x2,int y2,int act_num);
void boss_level_ep2(void);
int  boss_die_ep2(void);
void closing_sequence_ep2(void);

/* Boss functions - Episode 3 (defined in boss_ep3.c) */
int  boss_movement_ep3(ACTOR *actr);
void check_boss_hit_ep3(void);
void boss_level_ep3(void);
int  boss_die_ep3(void);
void closing_sequence_ep3(void);
void ending_screen_ep3(void);
int  endgame_movement_ep3(void);
