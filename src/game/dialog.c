...
char *options_bobstv[]={
              ...
              "Forget it",
              NULL};
// Episode 1: "Horizontal Syncopation ", Episodes 2-3: "Horizontal Syncapation "
char *options_tv_ep1[]={
              "Bad Picture Tube",
              "Horizontal Syncopation ",
              "Nothing",
              NULL};
char *options_tv_ep23[]={
              "Bad Picture Tube",
...
char *options_mailphone[]={
              ...
              NULL};
//===========================================================================
/* d_restore() is defined in back.c (ep1) or grp.c (ep2/3) */
//===========================================================================
...
if(g_episode == 1) options_tv = options_tv_ep1;
else options_tv = options_tv_ep23;
